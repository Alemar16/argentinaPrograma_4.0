...
SubProceso  seleccion 
	Definir selec, muro1, largo, alto, largo1, espesor Como Real
	largo = 0
	alto = 0
	largo1 = 0  
	espesor = 0
...
FinSubProceso
	SubProceso columna(largo1)
		...
		Leer largo1
		Escribir "PARA LA COLUMNA DE LARGO " largo1 "Mts"
		...
		Escribir largo1 * 3 " METROS DE HIERRO DEL 4"
FinSubProceso
SubProceso pisos(a, b, c)
	Definir super1, espesor2, a1, l1 Como Real
	Escribir "INGRESE EL ESPESOR DEL CONTRAPISOS"
	Leer espesor2
	Escribir "INGRESE EL ANCHO DE LA SUPERFICIE"
	Leer a1
	Escribir "INGRESE EL LARGO DE LA SUPERFICIE"
	Leer l1
	super1 = superficie1(a1,l1)
	Escribir "SE NECESECITAN " (super1 * espesor2)*105  " KG DE CEMENTOS"
	Escribir "SE NECESECITAN " (super1 * espesor2)*0.45 " M3 DE ARENA"
	Escribir "SE NECESECITAN " (super1 * espesor2)*0.9  " M3 DE PIEDRA"
FinSubProceso
...
FinFuncion
Funcion volumen = volumen1(a,b,c)
